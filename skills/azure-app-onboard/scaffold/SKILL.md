---
name: scaffold
description: Generate deployment-ready Bicep infrastructure from an Azure architecture plan and verify it with adversarial self-review. Invoked by the azure-app-onboard orchestrator at Phase 3; not directly user-routable.
---
