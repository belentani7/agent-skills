---
name: deploy
description: Execute validated infrastructure-as-code against Azure and verify deployed resource health. Invoked by the azure-app-onboard orchestrator at Phase 4; not directly user-routable.
---
