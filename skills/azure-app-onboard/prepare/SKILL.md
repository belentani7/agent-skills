---
name: prepare
description: Map application components to Azure services with cost estimation and quota validation. Invoked by the azure-app-onboard orchestrator at Phase 2; not directly user-routable.
---
